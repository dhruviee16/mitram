  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
        Every Mitram journey is built around verified partners, dedicated support and
        peace of mind for the family back home.
      </p>
      ...
      <div className="relative mx-auto mt-8 aspect-3/2 w-full max-w-4xl">
        <Image
          src="/images/safety/journey-shield.png"
          alt="A senior couple walking with their MITRAM coordinator past a temple, a safety shield watermark behind them"
          fill
          priority
          unoptimized
